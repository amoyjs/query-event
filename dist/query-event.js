(function (global, factory) {
    ...
    var u = {
        getCurTargetByEv: function (evTarget, ev) {
            var curTarget;
            var maxZindex = 0;
            if (common.getValue(evTarget, 'children.length')) {
        ...
        getFingers: function (ev) {
            return common.getValue(ev, 'data.originalEvent.touches.length') || 1;
        },
    ...
    exports.RTOUCH_SUPPORT_EVENT = RTOUCH_SUPPORT_EVENT;
    exports.default = queryEvent;
    exports.off = off;
    exports.on = on;
